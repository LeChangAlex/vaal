...
def get_args():
    ...
    parser.add_argument('--task_train_iterations', type=int, default=50000, help='Number of training iterations')
    parser.add_argument('--adv_train_iterations', type=int, default=50000, help='Number of training iterations')
