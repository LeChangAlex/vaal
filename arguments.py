...
def get_args():
    ...
    parser.add_argument('--task_train_iterations', type=int, default=8000, help='Number of training iterations')
    parser.add_argument('--adv_train_iterations', type=int, default=10000, help='Number of training iterations')
